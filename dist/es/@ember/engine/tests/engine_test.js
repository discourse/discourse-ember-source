...
import { moduleFor, AbstractTestCase as TestCase, verifyInjection, verifyRegistration } from 'internal-test-helpers';
let engine;
...
moduleFor('Engine', class extends TestCase {
  ...
  ['@test builds a registry'](assert) {
    ...
    verifyInjection(assert, engine, 'service:-routing', 'router', 'router:main'); // DEBUGGING
