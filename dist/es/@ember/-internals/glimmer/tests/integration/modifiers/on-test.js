...
if (EMBER_GLIMMER_ON_MODIFIER) {
  moduleFor('{{on}} Modifier', class extends RenderingTestCase {
    ...
    '@test asserts if the provided callback accesses `this` without being bound prior to passing to on'(assert) {
  ...
  moduleFor('Rendering test: non-interactive `on` modifier', class extends RenderingTestCase {
    getBootOptions() {
      return {
        isInteractive: false
      };
