...
import { expect } from '@glimmer/util'; // This simuates what the template hot-reloading would do in development mode
// to avoid regressions

moduleFor('Appliation test: template hot reloading', class extends ApplicationTestCase {
  constructor() {
    super(...arguments);
    ...
    this.add('service:reloader', Service.extend({
      init() {
    ...
    this.add('helper:hot-reload', Helper.extend({
