...
if (EMBER_IMPROVED_INSTRUMENTATION) {
  moduleFor('Helpers test: element action instrumentation', class extends RenderingTestCase {
    teardown() {
      super.teardown();
...
moduleFor('Helpers test: element action', class extends RenderingTestCase {
