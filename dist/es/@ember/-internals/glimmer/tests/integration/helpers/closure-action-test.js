...
import { subscribe as instrumentationSubscribe, unsubscribe as instrumentationUnsubscribe } from '@ember/instrumentation';
...
if (EMBER_IMPROVED_INSTRUMENTATION) {
  moduleFor('Helpers test: closure {{action}} improved instrumentation', class extends RenderingTestCase {
...
moduleFor('Helpers test: closure {{action}}', class extends RenderingTestCase {
  ...
  ['@test closure actions does not cause component hooks to fire unnecessarily [GH#14305] [GH#14654]'](assert) {
    ...
    assert.equal(didReceiveAttrsFired, 3);
    runTask(() => set(outer, 'onClick', function () {
