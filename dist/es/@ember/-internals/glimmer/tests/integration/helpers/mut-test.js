...
moduleFor('Helpers test: {{mut}}', class extends RenderingTestCase {
...
moduleFor('Mutable Bindings used in Computed Properties that are bound as attributeBindings', class extends RenderingTestCase {
  ...
  ['@test an attribute binding of a computed property with a setter of a 2-way bound attr recomputes when the attr changes']() {
    ...
    this.assertComponentElement(this.firstChild, {
      tagName: 'div',
      attrs: {
        style: styles('height: 35px; width: 70px;')
      },
      content: '70x35'
    });
    this.assertStableRerender();
    ...
    this.assertComponentElement(this.firstChild, {
      tagName: 'div',
      attrs: {
        style: styles('height: 40px; width: 80px;')
      },
      content: '80x40'
    });
    ...
    this.assertComponentElement(this.firstChild, {
      tagName: 'div',
      attrs: {
        style: styles('height: 45px; width: 90px;')
      },
      content: '90x45'
    });
