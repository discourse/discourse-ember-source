...
import { EMBER_GLIMMER_ANGLE_BRACKET_NESTED_LOOKUP, EMBER_GLIMMER_FORWARD_MODIFIERS_WITH_SPLATTRIBUTES } from '@ember/canary-features';
...
let BaseModifier = setModifierManager(owner => {
...
moduleFor('AngleBracket Invocation', class extends RenderingTestCase {
  ...
  '@test merges class attribute with `...attributes` in yielded contextual component ("splattributes")'() {
    ...
    this.assertElement(this.firstChild, {
      tagName: 'div',
      attrs: {
        class: classes('default-class custom-class'),
        title: 'foo'
      },
      content: 'hello'
    });
  ...
  '@test merges trailing class attribute with `...attributes` in yielded contextual component ("splattributes")'() {
    ...
    this.assertElement(this.firstChild, {
      tagName: 'div',
      attrs: {
        class: classes('custom-class default-class'),
        title: 'foo'
      },
      content: 'hello'
    });
...
moduleFor('AngleBracket Invocation (splattributes)', class extends RenderingTestCase {
  constructor() {
    super(...arguments);
...
if (EMBER_GLIMMER_ANGLE_BRACKET_NESTED_LOOKUP) {
  moduleFor('AngleBracket Invocation Nested Lookup', class extends RenderingTestCase {
...
if (EMBER_GLIMMER_FORWARD_MODIFIERS_WITH_SPLATTRIBUTES) {
  moduleFor('Element modifiers on AngleBracket components', class extends RenderingTestCase {
    ...
    '@test modifiers on components accept bound arguments and track changes on the'(assert) {
      ...
      assert.equal(modifiedElement && modifiedElement.getAttribute('id'), 'inner-div', 'Modifier is called on the element receiving the splattributes');
      runTask(() => setProperties(this.context, {
        something: 'another',
        foo: 'thingy'
      }));
