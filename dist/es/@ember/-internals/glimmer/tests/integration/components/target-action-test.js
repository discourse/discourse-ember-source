import { moduleFor, RenderingTestCase, ApplicationTestCase, strip, runTask } from 'internal-test-helpers';
...
moduleFor('Components test: sendAction', class extends RenderingTestCase {
  constructor() {
    super(...arguments);
    this.actionCounts = {};
    this.sendCount = 0;
  ...
  ['@test calling sendAction on a component within a block sends to the outer scope GH#14216'](assert) {
    let testContext = this; // overrides default action-delegate so actions can be added
...
moduleFor('Components test: sendAction to a controller', class extends ApplicationTestCase {
...
moduleFor('Components test: sendAction of a closure action', class extends RenderingTestCase {
...
moduleFor('Components test: send', class extends RenderingTestCase {
