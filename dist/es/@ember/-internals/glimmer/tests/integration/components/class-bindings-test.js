...
moduleFor('ClassNameBindings integration', class extends RenderingTestCase {
  ['@test it can have class name bindings on the class definition']() {
    ...
    this.assertComponentElement(this.firstChild, {
      tagName: 'div',
      attrs: {
        class: classes('ember-view foo enabled sad')
      },
      content: 'hello'
    });
    ...
    this.assertComponentElement(this.firstChild, {
      tagName: 'div',
      attrs: {
        class: classes('ember-view FOO sad')
      },
      content: 'hello'
    });
    runTask(() => {
    ...
    this.assertComponentElement(this.firstChild, {
      tagName: 'div',
      attrs: {
        class: classes('ember-view happy')
      },
      content: 'hello'
    });
    runTask(() => {
  ...
  ['@test attrs in classNameBindings']() {
    ...
    this.assertComponentElement(this.firstChild, {
      tagName: 'div',
      attrs: {
        class: classes('ember-view green black')
      },
      content: 'hello'
    });
    runTask(() => this.rerender());
    ...
    this.assertComponentElement(this.firstChild, {
      tagName: 'div',
      attrs: {
        class: classes('ember-view purple red')
      },
      content: 'hello'
    });
  ...
  ['@test it can have class name bindings in the template']() {
    ...
    this.assertComponentElement(this.firstChild, {
      attrs: {
        class: classes('ember-view some-initially-false-property some-initially-undefined-property static open down isFalsy')
      },
      content: 'hello'
    });
    runTask(() => {
  ...
  ['@test it can have class name bindings with nested paths']() {
    ...
    this.assertComponentElement(this.firstChild, {
      tagName: 'div',
      attrs: {
        class: classes('ember-view foo-bar enabled sad')
      },
      content: 'hello'
    });
    runTask(() => this.rerender());
    ...
    this.assertComponentElement(this.firstChild, {
      tagName: 'div',
      attrs: {
        class: classes('ember-view FOO-BAR sad')
      },
      content: 'hello'
    });
    runTask(() => {
  ...
  ['@test const bindings can be set as attrs']() {
    ...
    this.assertComponentElement(this.firstChild, {
      tagName: 'div',
      attrs: {
        class: classes('ember-view enabled')
      },
      content: 'hello'
    });
    runTask(() => this.rerender());
    ...
    this.assertComponentElement(this.firstChild, {
      tagName: 'div',
      attrs: {
        class: classes('ember-view disabled')
      },
      content: 'hello'
    });
  ...
  ['@test :: class name syntax works with an empty true class']() {
    ...
    this.assertComponentElement(this.firstChild, {
      tagName: 'div',
      attrs: {
        class: classes('ember-view not-enabled')
      },
      content: 'hello'
    });
  ...
  ['@test uses all provided static class names (issue #11193)']() {
    ...
    this.assertComponentElement(this.firstChild, {
      tagName: 'div',
      attrs: {
        class: classes('ember-view class-one class-two')
      },
      content: 'hello'
    });
    runTask(() => set(this.context, 'enabled', true));
  ...
  ['@test it can set class name bindings in the constructor']() {
    ...
    this.assertComponentElement(this.nthChild(0), {
      tagName: 'div',
      attrs: {
        class: classes('ember-view foo enabled')
      },
      content: 'hello'
    });
...
moduleFor('ClassBinding integration', class extends RenderingTestCase {
  ...
  ['@test it should merge classBinding with class']() {
    ...
    this.assertComponentElement(this.firstChild, {
      ...
      content: 'hello',
      attrs: {
        class: classes('respeck myName ember-view')
      }
    });
    runTask(() => this.rerender());
    this.assertComponentElement(this.firstChild, {
  ...
  ['@test it should apply classBinding with only truthy condition']() {
    ...
    this.assertComponentElement(this.firstChild, {
      ...
      content: 'hello',
      attrs: {
        class: classes('respeck  ember-view')
      }
    });
    runTask(() => this.rerender());
    this.assertComponentElement(this.firstChild, {
  ...
  ['@test it should apply classBinding with only falsy condition']() {
    ...
    this.assertComponentElement(this.firstChild, {
      ...
      content: 'hello',
      attrs: {
        class: classes('shade  ember-view')
      }
    });
    runTask(() => this.rerender());
    this.assertComponentElement(this.firstChild, {
  ...
  ['@test it should apply classBinding with falsy condition']() {
    ...
    this.assertComponentElement(this.firstChild, {
      ...
      content: 'hello',
      attrs: {
        class: classes('scrub  ember-view')
      }
    });
    runTask(() => this.rerender());
    this.assertComponentElement(this.firstChild, {
  ...
  ['@test it should apply classBinding with truthy condition']() {
    ...
    this.assertComponentElement(this.firstChild, {
      ...
      content: 'hello',
      attrs: {
        class: classes('fresh  ember-view')
      }
    });
    runTask(() => this.rerender());
    this.assertComponentElement(this.firstChild, {
