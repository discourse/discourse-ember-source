...
if (EMBER_GLIMMER_ANGLE_BRACKET_BUILT_INS) {
  ...
  moduleFor('<LinkTo /> component: .transitioning-in .transitioning-out CSS classes', class extends ApplicationTestCase {
    constructor() {
      super();
  ...
  moduleFor(`<LinkTo /> component: .transitioning-in .transitioning-out CSS classes - nested link-to's`, class extends ApplicationTestCase {
    constructor() {
      super();
      this.aboutDefer = RSVP.defer();
      this.otherDefer = RSVP.defer();
