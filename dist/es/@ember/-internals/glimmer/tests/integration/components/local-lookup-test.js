import { moduleFor, RenderingTestCase, ModuleBasedTestResolver, ApplicationTestCase, runTask } from 'internal-test-helpers';
...
if (EMBER_MODULE_UNIFICATION) {
  moduleFor('Components test: local lookup with resolution referrer (MU)', class extends ApplicationTestCase {
