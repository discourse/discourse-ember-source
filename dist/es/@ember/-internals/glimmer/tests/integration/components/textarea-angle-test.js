...
if (EMBER_GLIMMER_ANGLE_BRACKET_BUILT_INS) {
  ...
  applyMixins(TextAreaRenderingTest, new BoundTextAreaAttributes([{
  ...
  moduleFor('Components test: <Textarea>', class extends TextAreaRenderingTest {
  ...
  moduleFor('Components test: <Textarea>', class extends RenderingTestCase {
