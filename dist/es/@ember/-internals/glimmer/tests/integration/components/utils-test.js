...
import { getRootViews, getChildViews, getViewBounds, getViewClientRects, getViewBoundingClientRect } from '@ember/-internals/views';
import { Component } from '../../utils/helpers';
moduleFor('View tree tests', class extends ApplicationTestCase {
  constructor() {
    super(...arguments);
...
moduleFor('Bounds tests', class extends RenderingTestCase {
