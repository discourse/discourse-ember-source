    ...
    **/
    ...
    LinkComponent = EmberComponent.extend({
        ...
        */
        ...
        _route: computed('route', '_currentRoute', function computeLinkToComponentRoute() {
            let { route } = this;
        ...
        href: computed('_currentRouterState', '_route', '_models', '_query', 'tagName', 'loading', 'loadingHref', function computeLinkToComponentHref() {
            ...
            if (DEBUG) {
                ...
                try {
                    ...
                    // tslint:disable-next-line:max-line-length
                    assert(`You attempted to generate a link for the "${this.route}" route, but did not ` +
    ...
    LinkComponent = EmberComponent.extend({
        ...
        */
        ...
        didReceiveAttrs() {
            ...
            assert('You must provide one or more parameters to the `{{link-to}}` component.', params && params.length > 0);
