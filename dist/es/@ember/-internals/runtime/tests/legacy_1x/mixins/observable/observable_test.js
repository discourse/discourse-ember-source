...
moduleFor('object.get()', class extends AbstractTestCase {
  beforeEach() {
...
moduleFor('object.set()', class extends AbstractTestCase {
  beforeEach() {
...
moduleFor('Computed properties', class extends AbstractTestCase {
  beforeEach() {
...
moduleFor('Observable objects & object properties ', class extends AbstractTestCase {
  beforeEach() {
    object = ObservableObject.extend({
      getEach() {
...
moduleFor('object.addObserver()', class extends AbstractTestCase {
  beforeEach() {
...
moduleFor('object.removeObserver()', class extends AbstractTestCase {
  beforeEach() {
