...
moduleFor('EmberObject ES Compatibility', class extends AbstractTestCase {
  ...
  ['@test calling metaForProperty on a native class works'](assert) {
    ...
    defineProperty(SubEmberObject.prototype, 'foo', computed('foo', {
      get() {
        return 'bar';
      }
  ...
  '@test super and _super interop between old and new methods'(assert) {
    ...
    defineProperty(B.prototype, 'full', computed('first', 'last', {
      get() {
    ...
    addObserver(B.prototype, 'full', null, 'fullNameDidChange'); // Only string listeners are allowed for prototypes
