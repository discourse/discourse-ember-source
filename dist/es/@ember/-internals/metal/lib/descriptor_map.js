...
/**
  ...
  @private
*/
export function descriptorForProperty(obj, keyName, _meta) {
...
export function descriptorForDecorator(dec) {
...
/**
  ...
  @private
*/
export function isClassicDecorator(dec) {
...
/**
  ...
  @private
*/
export function setClassicDecorator(dec, value = true) {
