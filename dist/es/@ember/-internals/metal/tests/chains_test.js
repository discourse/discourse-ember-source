import { addObserver, get, set, ChainNode, finishChains, defineProperty, computed, alias, notifyPropertyChange, watch, unwatch, watcherCount } from '..';
...
moduleFor('Chains', class extends AbstractTestCase {
  ...
  ['@test observer and CP chains'](assert) {
    ...
    defineProperty(obj, 'qux', computed(function () {})); // create DK chains

    get(obj, 'foo'); // create observer chain
    ...
    */
    ...
    notifyPropertyChange(obj, 'qux'); // CP chain is blown away
  ...
  ['@test writable chains is not defined more than once'](assert) {
    ...
    defineProperty(Base.prototype, 'bar', computed('foo.bar', {
      get() {
        return this.foo.bar;
      }
    ...
    defineProperty(Base.prototype, 'value', alias('baz.value')); // Define an observer, which will eagerly attempt to setup chains and watch
