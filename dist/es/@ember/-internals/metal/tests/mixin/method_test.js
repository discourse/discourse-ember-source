...
moduleFor('Mixin Methods', class extends AbstractTestCase {
...
moduleFor('Method Conflicts', class extends AbstractTestCase {
...
moduleFor('system/mixin/method_test BUGS', class extends AbstractTestCase {
