...
import { Component, getTemplate, setTemplates, hasTemplate, setTemplate } from '@ember/-internals/glimmer';
import bootstrap from '../../lib/system/bootstrap';
import { runAppend, runDestroy, buildOwner, moduleFor, AbstractTestCase } from 'internal-test-helpers';
